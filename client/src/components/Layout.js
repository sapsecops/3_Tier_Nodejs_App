  ...
  return (
    <div className="app-layout">
      <header className="app-header slide-down">
        <div className="brand">
          <img src={logo} alt="sapsecops logo" className="logo" />
          <div>
            <h1 className="brand-title">SapSecOps</h1>
            <p className="nav-subtitle">SapSecOps UMS</p>
          </div>
        </div>
      </header>
      <AnimatedBanner message="Welcome to SapSecOps Solutions🚀" />
      ...
      <footer className="app-footer">
        <p>&copy; {new Date().getFullYear()} SapSecOps Solutions. All rights reserved.</p>
      </footer>
